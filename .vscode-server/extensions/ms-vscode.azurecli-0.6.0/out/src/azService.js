...
class AzService {
    ...
    getProcess() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.process = (() => __awaiter(this, void 0, void 0, function* () {
                const { stdout } = yield (0, utils_1.exec)('az --version');
    ...
    getSpawnProcessOptions() {
        return __awaiter(this, void 0, void 0, function* () {
            if (process.platform === 'darwin') {
                try {
                    const which = yield (0, utils_1.exec)('which az');
                    const binPath = yield (0, utils_1.realpath)(which.stdout.trim());
                    ...
                    if (binPath.startsWith(cellarBasePath)) {
                        ...
                        const entries = yield (0, utils_1.readdir)(libPath);
                        for (const entry of entries) {
                            const packagesPath = `${libPath}/${entry}/site-packages`;
                            if (yield (0, utils_1.exists)(packagesPath)) {
    ...
    spawn(pythonLocation, processOptions) {
        const process = (0, child_process_1.spawn)((0, path_1.join)(__dirname, `../../service/az-service${isWindows ? '.bat' : ''}`), [pythonLocation], processOptions);
